...
from flaskblog2 import db, bcrypt
from flaskblog2.models import User, Post
from flaskblog2.users.forms import (RegistrationForm, LoginForm, UpdateAccountForm,
...
def register():
    ...
    if form.validate_on_submit():
        ...
        db.session.add(user)
        db.session.commit()
        flash(f'Account succesfully created for {form.username.data}!', category='success')
